...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Argapuraku</b>Lupa Password</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Verifikasi Password Baru.</p>

      <form action="media.php?modul=auth&act=forgot" method="post">
